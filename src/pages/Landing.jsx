  ...
  return (
    <div className="ui-screen">
      <div id="app" className="relative w-full min-h-screen bg-white overflow-x-hidden">
        ...
        {/* --- Navigation --- */}
        <nav id="header" className="sticky top-0 z-50 w-full h-[80px] bg-white/80 backdrop-blur-md border-b border-gray-100 flex items-center justify-between px-20">
        ...
        {/* --- Hero Section --- */}
        <main id="hero-section" className="relative w-full min-h-[840px] flex items-center px-20 bg-[#F9FAFB]">
          <div className="w-1/2 flex flex-col gap-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 rounded-full w-fit shadow-sm">
              ...
              <span className="text-[14px] font-bold text-gray-600 uppercase tracking-wider">New Standard of Career Reflection</span>
            </div>
            <h1 className="text-[72px] font-black leading-[1.1] text-[#222222] tracking-tight">
              탈락을 질문으로<br/>
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#6366F1] to-[#A855F7]">돌아보는 취업 회고</span>
            </h1>
            <div className="flex flex-col gap-2">
              <p className="text-[24px] font-medium text-gray-500">답을 주지 않고, 생각을 정리합니다.</p>
        ...
        <section id="value-proposition" className="w-full py-32 px-20 bg-white">
          <div className="flex flex-col items-center text-center gap-6 mb-20">
            <h2 className="text-[48px] font-black text-[#222222]">왜 상담이 아니라 회고인가요?</h2>
            <p className="text-[20px] text-gray-500 max-w-[700px]">
              단순히 '왜 떨어졌을까'를 분석하는 것은 답을 주지 못합니다.<br/>
              스스로에게 던지는 깊이 있는 질문만이 다음 성장을 위한 진짜 답을 찾아줍니다.
            </p>
          </div>
        ...
        {/* --- Footer --- */}
        <footer id="footer" className="w-full py-16 px-20 bg-[#111111] text-white">
          <div className="flex justify-between items-start border-b border-white/10 pb-12">
            <div className="flex flex-col gap-6">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center">
                  <FontAwesomeIcon icon={faArrowsRotate} className="text-[#111111] text-sm" />
                </div>
                <span className="text-xl font-black tracking-tighter">RE:TRACE</span>
              </div>
              <p className="text-gray-400 text-[15px]">우리는 당신의 실패를 성공의 가장 강력한 질문으로 바꿉니다.</p>
            </div>
            <div className="flex gap-20">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex gap-4">
                  ...
                  <FontAwesomeIcon icon={faYoutube} className="text-xl text-gray-400 hover:text-white cursor-pointer" />
                </div>
              </div>
            </div>
          </div>
  ...
  return (
    <div className="p-10 bg-[#F9FAFB] rounded-[32px] border border-transparent hover:border-[#6366F1] transition-all group">
      <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center mb-8 shadow-sm group-hover:bg-[#6366F1] transition-colors">
        <FontAwesomeIcon icon={icon} className="text-2xl text-[#6366F1] group-hover:text-white" />
      </div>
